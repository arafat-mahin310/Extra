# Decompile by The Arafat-mahin (THE Arafat-mahin)
...
==================================================
           CODED BY : THE Arafat-mahin       
           WHATSAPP : +01925798757    
           FB PAGE  : Arafat-mahin / V-ViruX / 
==================================================           
...
|__/ |__| |  | |    | | \| |__]     |  |__| |__| |___
 [*]=============================================
    \x1b[0;91m\x1b[1;43m                  MAKING FILE THE Arafat-mahin:)                 \x1b[0m
 [*]=============================================
...
class dubb:
	def __init__(self):
		...
		os.system('sort -r "'+file+'" | uniq > /sdcard/Arafat-mahin')
		os.system('rm -rf /sdcard/1.txt')
		os.system('rm -rf /sdcard/theArafat-mahin.txt.txt')
...
class sort:
	def __init__(self):
		...
		link = input ("[?] Link 1 : ")
		link1 = input ("[?] Link 2 : ")
		os.system('cat /sdcard/Arafat-mahin.txt | grep "'+link+'" > /sdcard/1.txt')
		os.system('cat /sdcard/Arafat-mahin.txt | grep "'+link1+'" >> /sdcard/1.txt')
		os.system('sort -r /sdcard/1.txt | uniq > /sdcard/Xafthz.txt')
		os.system('rm -rf /sdcard/1.txt')
		os.system('rm -rf /sdcard/Arafat-mahin.txt.txt')
		os.system('rm -rf /sdcard/Arafat-mahinidz.txt')
		print(47*'\033[1;97m-\033[0;0m')
		print ("\n[â] Dumping and Sliced successfully ..")
...
class dump_ulti:
	def __init__(self):
		...
		os.system("rm -rf /storage/emulated/0/theArafat-mahin.txt")
		namq = ("theArafat-mahin")
		if namq == "" or namq == " ":
...
class lonte__:
	def __init__(self, ml, token, toket, mamk):
		...
		sys.stdout.write("\r%s[%sTHE Arafat-mahin%s] COLLECTED IDZ â¢> %s"%(Q,pilih([U,I,K,M,C]),Q, len(open('/sdcard/'+mamk+'.txt','r').readlines()))
		); sys.stdout.flush()
class menu:
	def __init__(self):
		global ua
